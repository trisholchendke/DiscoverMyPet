                ...
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>index.php?breeder/medication_history/<?php echo $row['patient_id']; ?>">
                            ...
                            <li class="divider"></li>
                            <!-- <li>
                                <a href="<?php echo base_url();?>index.php?breeder/patient/delete/<?php echo $row['patient_id']?>"
