        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php?breeder/stock/update/<?php echo $edit_data[0]['medicine_id']; ?>" method="post" enctype="multipart/form-data">
...
function get_medicine_subcategory(categoryID) {
    ...
    $.ajax({
		 url:"<?php echo base_url() ;?>index.php?breeder/get_medicine_subcategory",
		 dataType:"json",
