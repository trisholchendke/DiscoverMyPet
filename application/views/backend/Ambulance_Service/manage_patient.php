...
<table class="table table-bordered table-striped datatable" id="table-2">
    ...
    <tbody>
        <?php
            ...
            $patient_info = $this->db->get_where('patient', array('user_id' => $login_user_id))->result_array();
                ...
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>index.php?ambulance_service/medication_history/<?php echo $row['patient_id']; ?>">
                            ...
                            <li class="divider"></li>
                            <!-- <li>
                                <a href="<?php echo base_url();?>index.php?ambulance_service/patient/delete/<?php echo $row['patient_id']?>"
