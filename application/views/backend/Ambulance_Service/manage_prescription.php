    ...
    <tbody>
        <?php foreach ($prescription_info as $row) { ?>   
            <tr>
                ...
                <td>
                    <?php $name = $this->db->get_where('doctor' , array('user_id' => $row['user_id'] ))->row()->name;
                        echo $name;?>
                </td>
                <td>
                    <?php if($menu_check == 'from_prescription') { ?>
                    ...
                    <a  onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/manage_diagnosis_report/<?php echo $row['prescription_id']; ?>/<?php echo $row['user_id']; ?>');" 
                        class="btn btn-default btn-sm btn-icon icon-left">
                            <i class="fa fa-eye"></i>
                            View Diagnosis Report
                    </a>
                    <?php if($menu_check == 'from_prescription') { ?>
                        <a href="<?php echo base_url();?>index.php?ambulance_service/prescription/delete/<?php echo $row['prescription_id']?>/<?php echo $menu_check; ?>/<?php echo $row['patient_id']; ?>"
