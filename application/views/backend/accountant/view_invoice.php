...
//                 $currency_symbol    = $this->db->get_where('currency', array('currency_id' => $system_currency_id))->row()->currency_symbol;
                ...
                foreach ($invoice_entries as $invoice_entry)
                {
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <?php echo "INR" . $invoice_entry->amount; ?>
                        </td>
                    </tr>
                <?php } 
        ...
        <table width="100%" border="0">    
            <tr>
                ...
                <td align="right"><?php echo "INR" . $total_amount; ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="right"><?php echo "INR" . $row['discount_amount']; ?> </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="right"><h4><?php echo "INR" . $grand_total; ?> </h4></td>
            </tr>
        </table>
