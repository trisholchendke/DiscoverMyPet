...
<table class="table table-bordered table-striped datatable" id="table-2">
    ...
    <tbody>
        <?php 
        $medicine_info = $this->db->get_where('medicine' , array('user_id' => $this->session->userdata('login_user_id')))->result_array();
     	$array = json_decode(json_encode($medicine_info), True);
