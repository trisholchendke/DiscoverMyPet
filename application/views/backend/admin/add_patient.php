...
$(document).ready(function(){
	...
	validate = function (){
		if($('#blood_group').val() != "" && $('input[name=age]').val() != "" && $('input[name=birth_date]').val() != "" && $('#sex').val() != "" && $('input[name=phone]').val() != "" && $('#address').val() != "" && $('input[name=name]').val() != "" && $('input[name=email]').val() != "" && $('input[name=email]').val() != "" && $('input[name=password]').val() != ""){
            ...
            <div class="panel-body">
                ...
                <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php?admin/patient/create" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea id="address" name="address" class="form-control" id="field-ta"></textarea>
                        </div>
                    </div>
