...
$(document).ready(function(){
	...
	validate = function (){
		if($('#department').val() != "" && $('input[name=phone]').val() != "" && $('input[name=address]').val() != "" && $('input[name=name]').val() != "" && $('input[name=email]').val() != "" && $('input[name=email]').val() != "" && $('input[name=password]').val() != ""){
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <h3><?php echo get_phrase('add_sub_doctor'); ?></h3>
                </div>
            </div>

            <div class="panel-body">

                <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php?admin/sub_doctor/create" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea  name="profile" class="form-control html5editor" id="profile field-ta" data-stylesheet-url="assets/css/wysihtml5-color.css"></textarea>
                        </div>
                    </div>
