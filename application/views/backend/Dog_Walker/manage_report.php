    ...
    <div class="col-md-12">
                    ...
                    <tbody>
                        ...
                        foreach ($report_info as $row) { ?>   
                            <tr>
                                ...
                                <td>
                                               <a href="<?php echo base_url(); ?>index.php?/dog_walker/download_report/operation/<?php echo $row['report_id'] ;?>">
                        ...
                        foreach ($report_info as $row) { ?>   
                            <tr>
                                ...
                                <td>
                                  ...
                                  <td><?php echo $row['parent_name'] ?></td>
                                <td>
                                               <a href="<?php echo base_url(); ?>index.php?/dog_walker/download_report/birth/<?php echo $row['report_id'] ;?>">
            	<button class="btn btn-xs common_btn"><i class="fa fa-download" aria-hidden="true"></i></button>
            </a>
                    ...
                    <tbody>
                        ...
                        foreach ($report_info as $row) { ?>   
                            <tr>
                                ...
                                <td>
                                               <a href="<?php echo base_url(); ?>index.php?/dog_walker/download_report/death/<?php echo $row['report_id'] ;?>">
            	<button class="btn btn-xs common_btn"><i class="fa fa-download" aria-hidden="true"></i></button>
            </a>
        ...
        foreach ($array as $row) { ?>      
            <tr>
                ...
                <td>
                                               <a href="<?php echo base_url(); ?>index.php?/dog_walker/download_report/sale/<?php echo $row['invoice_id'] ;?>">
            	<button class="btn btn-xs common_btn"><i class="fa fa-download" aria-hidden="true"></i></button>
            </a>
