	...
	<script>
		...
		app.controller("add_invoice", function($scope) {
			...
			var refresh = function(){
				$.ajax({
	 				url:"<?php echo base_url();?>/index.php?dog_walker/invoice_manage/get_all_medicine",
	 				dataType:"json",
	 				type:"post",
    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open('dog_walker/invoice_add/create', array('class' => 'form-horizontal form-groups validate invoice-add', 'enctype' => 'multipart/form-data')); ?>
