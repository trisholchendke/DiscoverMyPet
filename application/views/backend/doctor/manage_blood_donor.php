...
<table class="table table-bordered table-striped datatable" id="table-2">
    ...
    <tbody>
        <?php $blood_donor_info = $this->db->get_where('blood_donor',array('doctor_id' =>  $this->session->userdata('login_user_id')))->result_array();
        foreach ($blood_donor_info as $row) { ?>   
            <tr>
                ...
                <td>
                    ...
                    <a href="<?php echo base_url();?>index.php?groomer/blood_donor/delete/<?php echo $row['blood_donor_id']?>" 
