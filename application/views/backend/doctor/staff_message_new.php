...
<div class="mail-header" style="padding-bottom: 27px ;">
    <!-- title -->
    <h3 class="mail-title">
        <?php echo get_phrase('staff_messsage'); ?>
...
<div class="mail-compose">
    ...
    <?php echo form_open('doctor/staff_message/send_new/', array('class' => 'form', 'enctype' => 'multipart/form-data')); ?>
	

    <div class="form-group">
        <label for="subject"><?php echo get_phrase('select_option *'); ?>:</label>
        <br><br>
        <select class="form-control" id="selected_mail_option" name="selected_mail_option" required>
			<option>- Select An Option -</option>
			<option>All Staff</option>
			<option>Particular Staff</option>
        </select>
    </div>
    ...
    <div class="form-group" id="select_user">
        ...
        <br><br>
        	<?php
                $staff = $this->db->get_where('users',array('doctor_id' => $this->session->userdata('login_user_id')))->result_array();
...
if($('#selected_mail_option').val() == "Particular Staff"){

$('#select_user').show();
}
if($('#selected_mail_option').val() == "All Staff"){
