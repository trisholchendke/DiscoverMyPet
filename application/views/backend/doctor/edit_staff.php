...
<button type="button" class="close pull-right close_btn" data-dismiss="modal" aria-hidden="true">×</button>
            ...
            <div class="panel-body">
                ...
                <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php?doctor/manage_staff/update" method="post" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-5">
                           <select name="role" class="form-control" value="<?php echo $user[0]['role']; ?>">
	                           	...
	                           	<option value="Breeder" <?php if($user[0]['role'] == "Breeder") echo "selected"?>>Breeder</option>
	                           	...
	                           	<option value="Obituary" <?php if($user[0]['role'] == "Restaurants") echo "selected"?>>Restaurants</option>
	                           	 <option value="Receptionist" <?php if($user[0]['role'] == "Receptionist") echo "selected"?>>Receptionist</option>
                           </select>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 control-label text_align_center">
