...
<table class="table table-bordered table-striped datatable" id="table-2">
    ...
    <tbody>
        ...
        $this->db->select('ms.id,ms.sub_category_for_all,ms.name medicine_sub_category_name,ms.doctor_id,mc.name medicine_category_name');
        ...
        $this->db->where('ms.doctor_id',$this->session->userdata('login_user_id'));
        $this->db->where('mc.medicine_category_id !=',0);
$this->db->or_where('ms.sub_category_for_all',"True");
...
?>
        	...
        	<tr>
                ...
                <td>
<?php if($row['sub_category_for_all'] == "True"){?>
