    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
             <form  id="form_valid" action="<?php echo base_url(); ?>index.php?doctor/add_staff/create" method="post" enctype="multipart/form-data" name="add_staff"   role="form" enctype="multipart/form-data" novalidate>
