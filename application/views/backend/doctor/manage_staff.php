 ...
 <table class="table table-bordered table-striped datatable" id="table-1">
                    ...
                    <tbody>
                        <?php
	                        ...
	                        $report_info    = $this->crud_model->select_user_info($login_user_id,$login_type);
                        foreach ($report_info as $row) { ?>   
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a  
                                       class="btn btn-danger btn-sm btn-icon icon-left" href="<?php echo base_url(); ?>index.php?doctor/manage_staff/delete/<?php echo $row['id'] ?>" onclick="return checkDelete();">
