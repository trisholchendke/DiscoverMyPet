                            ...
                            <tr>
                                ...
                                <td>
                                  ...
                                  <td><?php $name = $this->db->get_where('patient', array('patient_id' => $row['patient_id']))->row()->parent_name;
                                    ...
                                    ?></td>
                                <td>
                                               <a href="<?php echo base_url(); ?>index.php?/doctor/download_report/operation/<?php echo $row['report_id'] ;?>">
                            ...
                            <tr>
                                ...
                                <td>
                                  ...
                                  <td><?php $name = $this->db->get_where('patient', array('patient_id' => $row['patient_id']))->row()->parent_name;
                                    ...
                                    ?></td>
                                <td>
                                               <a href="<?php echo base_url(); ?>index.php?/doctor/download_report/birth/<?php echo $row['report_id'] ;?>">
            	<button class="btn btn-xs common_btn"><i class="fa fa-download" aria-hidden="true"></i></button>
            </a>
    	...
    	$report_info =  $query->result_array();
                        ...
                        foreach ($report_info as $row) { ?>   
                            <tr>
                                ...
                                <td>
                                               <a href="<?php echo base_url(); ?>index.php?/doctor/download_report/death/<?php echo $row['report_id'] ;?>">
            	<button class="btn btn-xs common_btn"><i class="fa fa-download" aria-hidden="true"></i></button>
            </a>
