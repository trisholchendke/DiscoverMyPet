                        ...
                        foreach ($report_info as $row) { ?>   
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a  
                                       class="btn btn-danger btn-sm btn-icon icon-left" href="<?php echo base_url(); ?>index.php?obituary/manage_staff/delete/<?php echo $row['id'] ?>" onclick="return checkDelete();">
