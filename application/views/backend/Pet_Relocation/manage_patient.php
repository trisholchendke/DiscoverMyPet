                ...
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>index.php?pet_relocation/medication_history/<?php echo $row['patient_id']; ?>">
                            ...
                            <li class="divider"></li>
                            <!-- <li>
                                <a href="<?php echo base_url();?>index.php?pet_relocation/patient/delete/<?php echo $row['patient_id']?>"
