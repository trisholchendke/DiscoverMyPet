    ...
    <tbody>
        <?php foreach ($diagnosis_report_info as $row) { ?>   
            <tr>
                ...
                <?php if($user_id == $this->session->userdata('login_user_id')) { ?>
                <td>
                    <a href="<?php echo base_url();?>index.php?trainers/diagnosis_report/delete/<?php echo $row['diagnosis_report_id']?>" 
...
<?php } if($trainersd == $this->session->userdata('login_user_id')) { ?>
<hr>
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php?trainers/diagnosis_report/create" method="post" enctype="multipart/form-data">
